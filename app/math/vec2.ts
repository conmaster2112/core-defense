interface Vec2Constructor {
     ...
     */
    addS(vec: Vec2Like, scalar: number): Vec2;
     ...
     */
    subtractS(vec: Vec2Like, scalar: number): Vec2;
...
Vec2.add = function add(vec1: Vec2Like, vec2: Vec2Like): Vec2 {
    return sP({ x: vec1.x + vec2.x, y: vec1.y + vec2.y }, Vec2.prototype);
};

Vec2.addS = function addS(vec1: Vec2Like, scalar: number): Vec2 {
    return sP({ x: vec1.x + scalar, y: vec1.y + scalar }, Vec2.prototype);
};

Vec2.prototype.add = function add(this: Vec2Like, vec: Vec2Like): Vec2 {
    return Vec2.add(this, vec);
};

Vec2.prototype.addS = function addS(this: Vec2Like, scalar: number): Vec2 {
    return Vec2.addS(this, scalar);
};

Vec2.subtract = function subtract(vec1: Vec2Like, vec2: Vec2Like): Vec2 {
    return sP({ x: vec1.x - vec2.x, y: vec1.y - vec2.y }, Vec2.prototype);
};

Vec2.subtractS = function subtractS(vec1: Vec2Like, scalar: number): Vec2 {
    return sP({ x: vec1.x - scalar, y: vec1.y - scalar }, Vec2.prototype);
};

Vec2.prototype.subtract = function subtract(this: Vec2Like, vec: Vec2Like): Vec2 {
    return Vec2.subtract(this, vec);
};

Vec2.prototype.subtractS = function subtractS(this: Vec2Like, scalar: number): Vec2 {
